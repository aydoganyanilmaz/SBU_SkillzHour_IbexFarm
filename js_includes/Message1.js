...
jqueryWidget: {
    _init: function () {
        ...
        this.element.addClass(this.cssPrefix + "message1");
        ...
        assert((! this.transfer) || this.transfer == "click" || this.transfer == "keypress" || typeof(this.transfer) == "number",
               "Value of 'transfer' option of Message1 must either be the string 'click' or a number");
        ...
        if (this.transfer == "click") {
            ...
            assert(! this.consentRequired, "The 'consentRequired' option of the Message1 controller can only be set to true if the 'transfer' option is set to 'click'.");
