...
jqueryWidget: {
    _init: function() {
        ...
        if (typeof(this.options.s) == "string") {
            ...
            assert_is_arraylike(this.options.s, "Bad value for 's' option of ADashedSentence.");
        ...
        assert(this.mode == "self-paced reading" || this.mode == "speeded acceptability",
               "Value of 'mode' option for ADashedSentence controller must be either " +
        ...
        this.wordTime = dget(this.options, "wordTime", this.display == "in place" ? 700 : 700); // TR to 700 -Only for speeded accpetability.
        ...
        assert(this.display == "dashed" || this.display == "in place",
               "Value of 'display' option for ADashedSentence controller must be either " +
