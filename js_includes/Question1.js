...
jqueryWidget: {
    _init: function () {
        ...
        var questionField = "Question1 (NULL if none).";
        ...
        if (typeof(this.hasCorrect) == "string") {
            ...
            assert(foundIt, "Value of 'hasCorrect' option not recognized in Question1");
        }
        ...
        if (! (this.hasCorrect === false))
            assert(typeof(this.hasCorrect) == "number" && this.hasCorrect < this.answers.length,
                   "Bad index for correct answer in Question1");
